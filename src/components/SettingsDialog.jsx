            ...
            <div className="fixed inset-0 bg-black/20 backdrop-blur-md flex items-center justify-center z-50"
                ...
                <div className="w-125 bg-nero-900 border border-nero-700 rounded-2xl shadow-2xl p-5"
                    ...
                    <div className="flex items-center justify-between mb-5">
                        ...
                        <button onClick={onClose} className="text-nero-500 hover:text-nero-300">
                            ✕
                        </button>
                    </div>
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <button
                            onClick={toggleTheme}
                            className={`relative w-12 h-6 rounded-full transition-colors ${theme === "dark" ? "bg-blue-500" : "bg-nero-700"}`}
                        >
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                disabled={syncing}
                                className="w-full px-3 py-1.5 rounded-md bg-nero-700 hover:bg-nero-600 text-sm flex items-center justify-center gap-2 disabled:opacity-50"
                            >
                    ...
                    <div className="mb-2">
                        ...
                        <div className="flex items-center gap-2">
                            <input
                                ...
                                className=" flex-1 px-3 py-2 bg-nero-800 border border-nero-700 rounded-lg text-sm text-nero-300 outline-none focus:border-nero-400"
                            />

                            <button
                                onClick={pickCSV}
                                title="Browse"
                                className=" w-10 h-10 flex items-center justify-center rounded-lg bg-nero-800 hover:bg-nero-700 text-nero-300"
                            >
                                <IoFolderOpenOutline />
                            </button>
                        </div>
                        ...
                        <div className="flex justify-end mt-3">
                            <button
                                onClick={savePath}
                                disabled={saving}
                                className=" px-4 py-1.5 rounded-lg bg-nero-700 hover:bg-nero-600 text-sm disabled:opacity-50"
                            >
                                {saving ? "Saving…" : "Apply"}
                            </button>
                        </div>
